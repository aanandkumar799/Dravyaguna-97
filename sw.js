const CACHE_NAME = 'dravya-guna-97-v13';
const APP_SHELL = [
...
self.addEventListener('fetch', event => {
  ...
  // Data: always try the network first so published plant changes appear promptly.
  ...
  // HTML: network first, with the cached page available when offline.
