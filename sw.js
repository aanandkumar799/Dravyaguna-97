const CACHE_NAME = 'dravya-guna-97-v20';
const APP_SHELL = [
  ...
  './data/curated-image-manifest.json','./plant-index.json','./plants.json','./manifest.json','./robots.txt','./sitemap.xml','./favicon-exact.jpg'
];
